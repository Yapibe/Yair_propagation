...
pathway_path = path.join(root_dir, 'Data', 'H_sapiens', 'pathways')
add_description_to_pathway_file(path.join(pathway_path, 'bio_pathways'), path.join(pathway_path, 'bio_pathways_gmt.gmt'))